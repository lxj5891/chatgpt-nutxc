<template>
  <div
    ...
    style="padding: 20px"
  >
    <div class="w-2/6 sm:w-2/6 bg-white rounded-lg">
      ...
      <div class="flex flex-col px-2">
        <div class="space-y-4">
          <div style="margin-bottom: 20px; margin-top: 20px;">
            <div class="flex flex-col px-2" style="margin-left: 40px;">
              KEY(会员号): 
            </div>
            <div class="flex flex-col px-2 form-item" style="margin-left: 40px;     width: 50%;">
              <input
                type="text"
                placeholder="请输入"
          ...
          <div class="flex flex-col px-2" style="margin-left: 40px; color: red">
              {{ signin.message  }}
          </div>
        </div>
